...
/* USER CODE BEGIN 0 */
//-------------------------------------------------
//          global variables/defines/enums
//-------------------------------------------------
data_packet_struct 			Data_Packet[2]  = {0};
volatile int                Previous        = PACKET_NONE;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, STATUS_ETH_Pin|STATUS_REG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : STATUS_ETH_Pin STATUS_REG_Pin */
  GPIO_InitStruct.Pin = STATUS_ETH_Pin|STATUS_REG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
